...
class ProductController extends ApiController
{
    ...
    { 
        ...
        // Build reverse map: competitor_product_id => own_product_id
        // One extra query only — scans assigned_competitors_product JSON of all own products.
        ...
        // Attach mapped_own_product_id to each product model
