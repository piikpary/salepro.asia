    ...
    $menu->dropdown(
        ...
        function ($sub) {
            $sub->url(
                ...
                [
                    'icon' => 'fa fas fa-book',
                    'active' => request()->segment(1) == 'manufacturing' && request()->segment(2) == 'recipe',
                ]
            );
            ...
            $sub->url(
                ...
                [
                    ...
                    'active' => request()->segment(1) == 'manufacturing' && request()->segment(2) == 'production' && request()->segment(3) == null,
                ]
            );
            ...
            $sub->url(
                ...
                [
                    ...
                    'active' => request()->segment(1) == 'manufacturing' && request()->segment(2) == 'production' && request()->segment(3) == 'create',
                ]
            );
            ...
            $sub->url(
                ...
                [
                    'icon' => 'fa fas fa-cog',
                    'active' => request()->segment(1) == 'manufacturing' && request()->segment(2) == 'settings',
                ]
            );
            ...
            $sub->url(
                ...
                [
                    ...
                    'active' => request()->segment(1) == 'manufacturing' && request()->segment(2) == 'report',
                ]
            );
        },
        [
            ...
            if (auth()->user()->can('purchase_n_sell_report.view') || auth()->user()->can('contacts_report.view')
                ...
                function ($sub) use ($enabled_modules, $is_admin, $is_business_owner) {
                    ...
                    if (auth()->user()->can('daily_sale_summary.view')) {
                        $sub->url(
                            action([\App\Http\Controllers\ReportController::class, 'DailySaleSummary']),
                            __('Daily Sales & Summary Report'),
                            ['icon' => 'fa fas fa-calendar-check', 'active' => request()->segment(2) == 'daily-sale-summary']
                        );
                    }
            ...
            if (auth()->user()->can('business_settings.access') ||
                ...
                auth()->user()->can('product_sale_target.access')) {
                $menu->dropdown(
                    ...
                    function ($sub) use ($enabled_modules) {
                        ...
                        if (auth()->user()->can('product_sale_target.access')) {
                            $sub->url(
                                action([\App\Http\Controllers\ProductSaleTargetController::class, 'index']),
                                __('Sale Target'),
                                ['icon' => 'fa fas fa-bullseye', 'active' => request()->segment(1) == 'product-sale-targets']
                            );
                        }
                    },
            ...
            $menu->dropdown(
                ...
                function ($sub) {
		         ...
		         $sub->url(
                                route('smart-call-plans.index'),
                                __('Smart Call Plan'),
                                ['icon' => 'fa fas fa-phone-volume', 'active' => request()->segment(1) == 'smart-call-plans']
                            );
                        // if (session('business.id') == 53) {
                            $sub->url(
