      ...
      <div class="row check_group">
        ...
        <div class="col-md-9">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'sale_order.create', in_array('sale_order.create', $role_permissions),
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'van_sale.create', in_array('van_sale.create', $role_permissions),
      ...
      <hr>
        ...
        @endif
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'daily_sale_summary.view', in_array('daily_sale_summary.view', $role_permissions),
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'product_sale_target.access', in_array('product_sale_target.access', $role_permissions), ['class' => 'input-icheck']); !!}
