...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 text-right mb-12" >
            ...
            @auth
                @if(!empty($sale_type) && $sale_type == 'sales_order')
                    <a href="{{action([\App\Http\Controllers\SalesOrderController::class, 'index'])}}" class="btn btn-success no-print btn-sm"><i class="fas fa-backward"></i>
                    </a>
                @else
