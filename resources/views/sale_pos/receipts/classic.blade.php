...
<div class="row" style="color: #000000 !important;">
	...
	<div class="col-xs-6">
		...
		@if($has_payments)
			...
			{{-- sales_order: show actual reward values; sell (business 53/102): show blank lines --}}
			@if($receipt_details->transaction_type == 'sales_order' && !empty($receipt_details->money_reward))
				<table style="width: 100%; margin-top: 0px; border-collapse: separate;">
					<tr>
						...
						<td style="padding: 3px 0; width: 41%; border-bottom: 1px dotted #000 !important;">$ {{ $receipt_details->money_reward }}</td>
					</tr>
					<tr>
						<td style="padding: 3px 0; width: 54%;">- ភាគរយ</td>
						<td style="padding: 3px 0; width: 5%;">:</td>
						<td style="padding: 3px 0; width: 41%; border-bottom: 1px dotted #000 !important;">{{ $receipt_details->money_percentage_amount }}</td>
					</tr>
					<tr>
						<td style="padding: 3px 0; width: 54%;">- លុយត្រូវទូទាត់</td>
						<td style="padding: 3px 0; width: 5%;">:</td>
						<td style="padding: 3px 0; width: 41%; border-bottom: 1px dotted #000 !important;">{{ $receipt_details->amount_to_pay }}</td>
					</tr>
					<tr>
			...
			@elseif(in_array($receipt_details->business_id, [53, 102]))
				<table style="width: 100%; margin-top: 0px; border-collapse: separate;">
					<tr>
						<td style="padding: 3px 0; width: 54%;">- លុយរង្វាន់</td>
						<td style="padding: 3px 0; width: 5%;">:</td>
