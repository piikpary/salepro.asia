...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('sell_list_filter_customer_group_id', __('Customer Group') . ':') !!}
                {!! Form::select('sell_list_filter_customer_group_id', $customer_groups, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'sell_list_filter_customer_group_id']) !!}
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <table class="table table-bordered table-striped" id="sales_order_table">
                            ...
                            <tfoot>
                                <tr style="background-color: #D2D6DE;">
                                    <th colspan="12" style="color: black;">Total:</th>
...
$(document).ready(function() {
    var table = $('#sales_order_table').DataTable({
        ...
        ajax: {
            ...
            error: function(xhr, error, thrown) {
                // Always hide the processing overlay first
                $('#sales_order_table').DataTable().processing(false);
                ...
                if (xhr.status === 401) {
                    ...
                    toastr.warning('Page expired. Reloading...');
                    setTimeout(function() {
        ...
        columns: [
            ...
            { data: 'customer_group_name', name: 'customer_groups.name' },
    ...
    function toggleFilters(tab) {
        const filtersToDisable = [
            ...
            '#sell_list_filter_customer_group_id'
        ];
    ...
    $('#sell_list_filter_location_id, #sell_list_filter_contact_id, #sell_list_filter_province_id, #sell_list_filter_district_id, #sell_list_filter_commune_id, #sell_list_filter_customer_group_id, #sell_list_filter_user_id').change(function() {
