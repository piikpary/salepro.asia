			...
			@component('components.widget', ['class' => 'box-solid'])
			    ...
			    <div class="col-md-6">
			    	<div class="form-group">
						...
						{!! Form::textarea('money_reward', $transaction->money_reward, ['class' => 'form-control', 'rows' => 1, 'placeholder' => 'Reward Note', 'style' => 'resize:none; height:38px;']); !!}
					</div>
			    </div>
			    <div class="col-md-6">
			    	<div class="form-group">
						{!! Form::label('money_percentage', 'Reward Percentage (%)') !!}
						{!! Form::text('money_percentage', $transaction->money_percentage, ['class' => 'form-control', 'placeholder' => '0.00', 'inputmode' => 'decimal', 'style' => 'height:38px;']); !!}
					</div>
			    </div>
			    @endif
